...
var snapblocks = (function () {
  ...
  */
    ...
    if (o) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          console.log("define");
          console.log("lang", _lang.definePrefix, _lang.defineSuffix);
          ...
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              ...
              if (_child2.isLabel) {
                ...
                console.log("part", _parts[_parts.length - 1]);
    ...
    _createClass(Style, null, [{
      ...
      value: function makeIcons() {
        return [SVG$2.el("path", {
          ...
          id: "list"
        }), SVG$2.setProps(SVG$2.el("polygon", {
  ...
  var BlockView$2 = /*#__PURE__*/function () {
    ...
    _createClass(BlockView, [{
      ...
      value: function drawSelf(w, h, lines) {
        // mouths
        if (lines.length > 1) {
          return SVG$2.mouthRect(w, h, this.isFinal, lines, {
        ...
        for (var _i2 = 0, _lines = lines; _i2 < _lines.length; _i2++) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              if (_child.isArrow) {
                objects.push(SVG$2.move(innerWidth - 15, this.height - 3, _child.el));
                continue;
              }
  ...
  var highContrastIcons = new Set(["dropdownArrow", "turnRight", "turnLeft", "loopArrow", "musicBlock", "penBlock", "videoBlock", "ttsBlock", "translationBlock", "cloud", "turtle", "turtleOutline", "flash"]);
  ...
  var IconView$1 = /*#__PURE__*/function () {
    ...
    _createClass(IconView, [{
      ...
      value: function draw(iconStyle) {
        return SVG$1.symbol("#sb3-" + iconName(this.name, iconStyle), {
          width: this.width,
          height: this.height
        });
      }
  ...
  var Style = /*#__PURE__*/function () {
    ...
    _createClass(Style, null, [{
      ...
      value: function bevelFilter(id, inset) {
        ...
        var alpha = "SourceAlpha";
        var s = inset ? -0.4 : 0.2;
        var blur = f.blur(0.5, alpha);
        f.merge(["SourceGraphic", f.comp("in", f.flood("#fff", 0.7), f.subtract(alpha, f.offset(+s, +s, blur))), f.comp("in", f.flood("#000", 0.9), f.subtract(alpha, f.offset(-(s * 3), -(s * 3), blur)))]);
        return f.el;
      }
    }, {
      key: "darkFilter",
  ...
  var IconView = /*#__PURE__*/function () {
    ...
    _createClass(IconView, [{
      ...
      key: "draw",
      value: function draw() {
        var symbol = SVG.symbol("#snap-" + this.name, {
          width: this.width,
          height: this.height
        });
  ...
  var InputView = /*#__PURE__*/function () {
    ...
    _createClass(InputView, [{
      ...
      value: function draw(parent) {
        ...
        this.width = w;
        var h = this.height = this.isRound || this.isColor ? this.label.height + 1 : this.label.height + 2;
        var el = InputView.shapes[this.shape](w, h);
        if (this.isColor) {
          SVG.setProps(el, {
            fill: this.value
    ...
    _createClass(BlockView, [{
      ...
      value: function draw() {
        ...
        for (var _i2 = 0, _lines = lines; _i2 < _lines.length; _i2++) {
          var _line = _lines[_i2];
          if (_line.isScript) {
            objects.push(SVG.move(15, _line.y, _line.el));
            continue;
          }
          var h = _line.height;
          var _iterator4 = _createForOfIteratorHelper(_line.children),
            _step4;
          try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
              var _child = _step4.value;
              if (_child.isArrow) {
                objects.push(SVG.move(innerWidth - 15, this.height - 3, _child.el));
                continue;
              }
              var _y = pt + (h - _child.height - pt - pb) / 2 - 1;
              if (isDefine && _child.isLabel) {
  ...
  var DocumentView = /*#__PURE__*/function () {
    ...
    _createClass(DocumentView, [{
      ...
      value: function render(cb) {
        ...
        var height = 0;
        var elements = [];
        var _iterator7 = _createForOfIteratorHelper(this.scripts),
          _step7;
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
