  ...
  */
  ...
  var scratchCommands = [{
    ...
    specDefs: {
      ...
      info: ["%1 {info}", "%1 @delInput @addInput", "%1 @delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s"],
    shape: "stack",
    category: "looks"
    ...
    spec: "run %1 {closed}",
    specDefs: {
      closed: ["input list: %2", "@addInput", "@verticalEllipsis @addInput", "with inputs %2 {inputs}"],
      inputs: ["%2 {inputs}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s", "%s"],
    shape: "stack",
    category: "control"
    ...
    specDefs: {
      closed: ["input list: %2", "@addInput", "@verticalEllipsis @addInput", "%2 {expanded}"],
      expanded: ["%2 {expanded}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s", "%s"],
    shape: "reporter",
    category: "control"
    ...
    specDefs: {
      closed: ["input list: %2", "@addInput", "@verticalEllipsis @addInput", "with inputs %3 {inputs}"],
      inputs: ["%3 {inputs}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    ...
    spec: "{sum}",
    specDefs: {
      sum: ["%1 + %2", "sum %1", "sum @addInput", "sum @verticalEllipsis @addInput", "%1 + %2 {add}"],
      add: ["+ %2 {add}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "operators"
    ...
    spec: "{product}",
    specDefs: {
      product: ["%1 {operator} %2", "product %1", "product @addInput", "product @verticalEllipsis @addInput", "%1 {operator} %2 {add}"],
      add: ["{operator} %2 {add}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"],
      operator: ["*", "×", "x"]
    },
    inputs: ["%n", "%n"],
    shape: "reporter",
    ...
    spec: "{minimum}",
    specDefs: {
      minimum: ["%1 min %2", "minimum %1", "minimum @addInput", "minimum @verticalEllipsis @addInput", "%1 min %2 {min}"],
      min: ["min %2 {min}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "operators"
    ...
    spec: "{maximum}",
    specDefs: {
      maximum: ["%1 max %2", "maximum %1", "maximum @addInput", "maximum @verticalEllipsis @addInput", "%1 max %2 {max}"],
      max: ["max %2 {max}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%n", "%n"],
    shape: "reporter",
    category: "operators"
    ...
    spec: "{all}",
    specDefs: {
      all: ["%1 < %2", "all < %1", "all < @addInput", "all < @verticalEllipsis @addInput", "%1 < %2 {less}"],
      less: ["< %2 {less}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s", "%s"],
    shape: "boolean",
    category: "operators"
    ...
    spec: "{all}",
    specDefs: {
      all: ["%1 {operator} %2", "all {operator} %1", "all {operator} @addInput", "all {operator} @verticalEllipsis @addInput", "%1 {operator} %2 {less}"],
      less: ["{operator} %2 {less}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"],
      operator: ["<=", "≤"]
    },
    inputs: ["%s", "%s"],
    shape: "boolean",
    ...
    spec: "{all}",
    specDefs: {
      all: ["%1 {operator} %2", "neighbors {operator} %1", "neighbors {operator} @addInput", "neighbors {operator} @verticalEllipsis @addInput", "%1 {operator} %2 {less}"],
      less: ["{operator} %2 {less}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"],
      operator: ["!=", "≠"]
    },
    inputs: ["%s", "%s"],
    ...
    spec: "{all}",
    specDefs: {
      all: ["%1 and %2", "all %1", "all @addInput", "all @verticalEllipsis @addInput", "%1 and %2 {less}"],
      less: ["and %2 {less}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%b", "%b"],
    shape: "boolean",
    category: "operators"
    ...
    spec: "{any}",
    specDefs: {
      any: ["%1 or %2", "any %1", "any @addInput", "any @verticalEllipsis @addInput", "%1 or %2 {less}"],
      less: ["or %2 {less}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%b", "%b"],
    shape: "boolean",
    category: "operators"
    ...
    spec: "join {closed}",
    specDefs: {
      closed: ["%1 %2", "input list: %1", "@verticalEllipsis @addInput", "@addInput", "{info}"],
      info: ["%1 {info}", "%1 @delInput @addInput", "%1 @delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s", "%s"],
    shape: "reporter",
    ...
    spec: "is {all} ?",
    specDefs: {
      all: ["%1 identical to %2", "all identical %1", "all identical @addInput", "all identical @verticalEllipsis @addInput", "%1 identical to %2 {less}"],
      less: ["identical to %2 {less}", "@delInput @addInput", "@delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%b", "%b"],
    shape: "boolean",
    category: "operators"
    ...
    specDefs: {
      parameters: ["input list: %1", "@addInput", "@verticalEllipsis @addInput", "{variadic}"],
      variadic: ["%1 {variadic}", "%1 @delInput @addInput", "%1 @delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s", "%s"],
    shape: "reporter",
    category: "operators"
    ...
    specDefs: {
      ...
      lists: ["{list} {lists}", "{list} @delInput @addInput", "{list} @delInput @verticalEllipsis @addInput"],
      list: ["%1", "@list"]
    },
    inputs: ["%m.list"],
    shape: "reporter",
    ...
    specDefs: {
      closed: ["input list: %2", "@addInput", "@verticalEllipsis @addInput", "{shape}"],
      shape: ["%2 {shape}", "%2 @delInput @addInput", "%2 @delInput @verticalEllipsis @addInput"]
    },
    inputs: ["%s", "%n"],
    shape: "reporter",
    category: "list"
    ...
    specDefs: {
      closed: ["input list: %1", "@addInput", "@verticalEllipsis @addInput", "{lists}"],
      lists: ["{list} {lists}", "{list} @delInput @addInput", "{list} @delInput @verticalEllipsis @addInput"],
      list: ["%2", "@list"]
    },
    inputs: ["%m.list"],
  ...
  var overrideCategories = ["motion", "looks", "sound", "variables", "list", "events", "control", "sensing", "operators", "custom", "custom-arg", "extension", "grey", "other", "obsolete"].concat(_toConsumableArray(Object.keys(extensions)), _toConsumableArray(Object.keys(aliasExtensions)));
  ...
  function loadLanguage(code, language) {
    ...
    Object.keys(language.commands).forEach(function (blockId) {
      ...
      if (m) {
        var image = m[0];
        var hash = nativeHash.replace(hashSpec(image), unicodeIcons$2[image]);
    ...
    Object.keys(language.commands).forEach(function (blockId) {
      var spec = language.commands[blockId];
      var block = {
        id: blockId,
        spec: spec
      };
    ...
    if (language.renamedBlocks) {
      Object.keys(language.renamedBlocks).forEach(function (spec) {
        var blockId = language.renamedBlocks[spec];
        var block = {
          id: blockId,
          spec: spec
        };
  ...
  var english = {
    ...
    of: {
      math: ["abs", "neg", "sign", "ceiling", "floor", "sqrt", "sin", "cos", "tan", "asin", "acos", "atan", "ln", "log", "lg", "e ^", "e^", "10 ^", "10^", "2 ^", "2^", "id"],
      list: ["length", "rank", "dimensions", "flatten", "columns", "uniques", "distribution", "sorted", "shuffled", "text", "lines", "csv", "json"],
      text: ["encode uri", "decode uri", "encode uri component", "decode uri component", "xml escape", "xml unescape", "js escape", "hex sha512 hash"]
    },
  ...
  allBlocks.forEach(function (info) {
    ...
    if (info.aliases) {
      var _iterator = _createForOfIteratorHelper(info.aliases),
        _step;
      try {
  ...
  registerCheck("OPERATORS_MATHOP", function (info, children, lang) {
  ...
  registerCheck("snap:reportTextFunction", function (info, children, lang) {
  ...
  registerCheck("snap:reportListAttribute", function (info, children, lang) {
    // Operators if text function
    var first = children[0];
    if (!first.isInput) {
      return;
  ...
  registerCheck("SENSING_OF", function (info, children, lang) {
    ...
    var name = first.value;
    return !lang.of.math.includes(name.toLowerCase()) && !lang.of.text.includes(name.toLowerCase());
  });
  ...
  specialCase("SENSING_OF", function (_, children, lang) {
    var first = children[0];
    if (!first.isInput) {
      return;
    }
    ...
    if (lang.of.list.includes(name.toLowerCase())) {
      return _objectSpread2({}, blocksById["snap:reportListAttribute"]);
    }
  });
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (child.shape === "dropdown") {
          ...
          var _iterator3 = _createForOfIteratorHelper(lang.soundEffects),
            _step3;
          try {
  ...
  disambig("SOUND_SETEFFECTO", "LOOKS_SETEFFECTTO", function (children, lang) {
    ...
    try {
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
        ...
        if (child.shape === "dropdown") {
          var name = child.value;
          var _iterator5 = _createForOfIteratorHelper(lang.soundEffects),
            _step5;
          try {
  ...
  specialCase("OPERATORS_LENGTH", function (_, children, lang) {
    var last = children[children.length - 1];
    if (last.isInput && last.shape === "dropdown" || last.isIcon) {
      return _objectSpread2({}, blocksById.DATA_LENGTHOFLIST);
    }
    return;
  });
  disambig("makeymakey.whenKeyPressed", "EVENT_WHENKEYPRESSED", function (children, _lang) {
    ...
    try {
      for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
        ...
        if (child.shape === "dropdown") {
          ...
          var _iterator7 = _createForOfIteratorHelper(lang.microbitWhen),
            _step7;
          try {
  ...
  registerCheck("snap:receiveCondition", function (info, children, lang) {
  ...
  disambig("snap:reportIfElse", "CONTROL_ELSE", function (children, _lang) {
    var first = children[3];
    if (first.isInput) {
      return true;
    }
    var last = children[5];
  ...
  disambig("snap:doSetGlobalFlag", "DATA_SETVARIABLETO", function (children, _lang) {
    var last = children[children.length - 1];
  ...
  specialCase("OPERATORS_MULTIPLY", function (_, children, lang) {
    var operators = children.filter(function (child) {
      return child.isLabel && ["*", "x"].includes(child.value.toLowerCase());
    });
    var last = children[children.length - 1];
    if (last.isIcon) {
      var _iterator10 = _createForOfIteratorHelper(operators),
        _step10;
      try {
  ...
  // convert / to ÷
  specialCase("snap:reportAtan2", function (_, children, lang) {
    var operators = children.filter(function (child) {
      return child.value === "/";
    });
    var _iterator11 = _createForOfIteratorHelper(operators),
      _step11;
    try {
      for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
        var operator = _step11.value;
        operator.value = "÷";
      }
    } catch (err) {
      _iterator11.e(err);
  ...
  // convert <= to ≤
  specialCase("snap:reportVariadicLessThanOrEquals", function (_, children, lang) {
    var operators = children.filter(function (child) {
      return child.value === "<=";
    });
    var _iterator12 = _createForOfIteratorHelper(operators),
      _step12;
    try {
      for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
        var operator = _step12.value;
        operator.value = "≤";
      }
    } catch (err) {
      _iterator12.e(err);
  ...
  // convert != to ≠
  specialCase("snap:reportVariadicNotEquals", function (_, children, lang) {
    var operators = children.filter(function (child) {
      return child.value === "!=";
    });
    var _iterator13 = _createForOfIteratorHelper(operators),
      _step13;
    try {
      for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
        var operator = _step13.value;
        operator.value = "≠";
      }
    } catch (err) {
      _iterator13.e(err);
  ...
  // convert >= to ≥
  specialCase("snap:reportVariadicGreaterThanOrEquals", function (_, children, lang) {
    var operators = children.filter(function (child) {
      return child.value === ">=";
    });
    var _iterator14 = _createForOfIteratorHelper(operators),
      _step14;
    try {
      for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
        var operator = _step14.value;
        operator.value = "≥";
      }
    } catch (err) {
      _iterator14.e(err);
  ...
  function fillSpecDef(part, defs) {
    if (/^{[^ {}\\]+}$/gm.test(part)) {
      var defName = part.slice(1, part.length - 1);
      if (defs[defName]) {
        var parts = [];
        var _iterator15 = _createForOfIteratorHelper(defs[defName]),
          _step15;
        try {
          for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
            var replacement = _step15.value;
            var replacementHash = hashSpec(replacement);
            var replacementParts = replacementHash.split(" ");
            var filledParts = fillSpecDef(replacementParts[0], defs);
            var _iterator16 = _createForOfIteratorHelper(filledParts),
              _step16;
            try {
              for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
                var _part = _step16.value;
                parts.push([_part].concat(_toConsumableArray(replacementParts.slice(1))).join(" "));
              }
            } catch (err) {
              _iterator16.e(err);
            } finally {
  ...
  function findAbstractBlocks(partialHashParts, fullHash, commands) {
    ...
    var _iterator17 = _createForOfIteratorHelper(commands),
      _step17;
    try {
      for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
        var _command = _step17.value;
        // console.log('abstract: command', command)
        // console.log('abstract: partialHashParts', partialHashParts)
        var originalSpec = hashSpec(_command.spec);
        var splitSpec = originalSpec.split(" ");
        var specs = [];
        if (_command.specDefs) {
          var filledParts = fillSpecDef(splitSpec[partialHashParts.length - 1], _command.specDefs);
          // console.log('')
          // console.log('abstract: filled spec parts', filledParts)
          var _iterator18 = _createForOfIteratorHelper(filledParts),
            _step18;
          try {
            for (_iterator18.s(); !(_step18 = _iterator18.n()).done;) {
              var filled = _step18.value;
              ...
              splitSpec = [].concat(_toConsumableArray(splitSpec.slice(0, partialHashParts.length - 1)), [filled], _toConsumableArray(splitSpec.slice(partialHashParts.length, splitSpec.length + 1)));
              var newSpec = splitSpec.join(" ");
        ...
        for (var _i2 = 0, _specs = specs; _i2 < _specs.length; _i2++) {
          var _spec = _specs[_i2];
          ...
          if (_spec.split(" ").filter(function (part) {
            return part !== "";
          }).join(" ").startsWith(partialHashParts.join(" "))) {
            partialCommands.push(_objectSpread2(_objectSpread2({}, _command), {}, {
              spec: _spec,
              parts: _spec.split(" ")
            }));
          }
    ...
    for (var _i = 0, _partialCommands = partialCommands; _i < _partialCommands.length; _i++) {
      var command = _partialCommands[_i];
      // take into account blank spec defs
      var spec = command.spec.split(" ").filter(function (part) {
        return part !== "";
      }).join(" ");
      if (spec === fullHash) {
  ...
  function lookupHash(hash, info, children, languages) {
    ...
    var allCommands = [];
    var _iterator19 = _createForOfIteratorHelper(languages),
      _step19;
    try {
      for (_iterator19.s(); !(_step19 = _iterator19.n()).done;) {
        var lang = _step19.value;
        ...
        for (var partIndex = 0; partIndex < splitHash.length; partIndex++) {
          var part = splitHash[partIndex];
          // console.log('abstract: part number', partIndex)
          var newCommands = findAbstractBlocks(splitHash.slice(0, partIndex + 1), hash, allCommands);
        ...
        if (full && allCommands.length > 0) {
          var _iterator21 = _createForOfIteratorHelper(allCommands),
            _step21;
          try {
            for (_iterator21.s(); !(_step21 = _iterator21.n()).done;) {
              var block = _step21.value;
              var blockById = blocksById[block.id];
              ...
              var specInfo = parseSpec(block.spec);
  ...
  function lookupDropdown(name, languages) {
    var _iterator23 = _createForOfIteratorHelper(languages),
      _step23;
    try {
      for (_iterator23.s(); !(_step23 = _iterator23.n()).done;) {
        var lang = _step23.value;
  ...
  function applyOverrides(info, overrides) {
    var _iterator24 = _createForOfIteratorHelper(overrides),
      _step24;
    try {
  ...
  function blockName(block) {
    var words = [];
    var _iterator25 = _createForOfIteratorHelper(block.children),
      _step25;
    try {
  ...
  function assert$3(bool, message) {
    if (!bool) {
  ...
  var Icon = /*#__PURE__*/function () {
    function Icon(name, modifiers) {
      ...
      assert$3(Icon.icons[name], "no info for icon " + name);
    }
    _createClass(Icon, [{
      key: "isIcon",
      get: function get() {
      ...
      key: "stringify",
      value: function stringify() {
        return unicodeIcons$2["@" + this.name] || "";
      }
    }], [{
      key: "icons",
      get: function get() {
  ...
  var Block = /*#__PURE__*/function () {
    function Block(info, children, comment) {
      ...
      this.hasPuzzle = shape === "stack" || shape === "hat" || shape === "cat" || shape === "c-block" || shape === "snap-define";
      ...
      this.isUpvar = this.isReporter && info.categoryIsDefault && children.length == 1 && children[0].isReporter;
    }
    _createClass(Block, [{
      key: "isBlock",
      get: function get() {
      ...
      value: function stringify(extras) {
        ...
        var text = this.children.map(function (child) {
          ...
          return child.isScript ? "{\n" + indent(child.stringify()) + "\n} " : child.isCommand ? "{" + child.stringify() + "}" : child.stringify().replace(/^\x20+|\x20+$/g, "") + " "; // keep newlines, while also trimming spaces
        }).join("").replace(/^\x20+|\x20+$/g, "");
    ...
    if (o) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (overrides.includes("define") && !isDefineBlock(children, _lang, !overrides.includes("define"))) {
            ...
            var _block = children[0];
            // console.log("block", block)
            // console.log("overrides", structuredClone(overrides))
            if (_block.info.categoryIsDefault) {
              _block.info.category = "custom";
            }
            continue;
          }
          if (!isDefineBlock(children, _lang, !overrides.includes("define"))) {
            continue;
          }
          ...
          var outlineShape = "stack";
          var blockChildren = children.slice(_lang.definePrefix.length, children.length - _lang.defineSuffix.length);
          ...
          if (blockChildren.length == 1 && !blockChildren[0].isLabel) {
            ...
            if (blockChildren[0] instanceof Input) {
              ...
              children = [].concat(_toConsumableArray(children.slice(0, _lang.definePrefix.length)), _toConsumableArray(blockChildren), _toConsumableArray(children.slice(children.length - _lang.defineSuffix.length)));
  ...
  function isDefineBlock(children, lang) {
    var testBlock = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    ...
    var outlineChildren = children.slice(lang.definePrefix.length, children.length - lang.defineSuffix.length);
  ...
  function parseLines(code, languages) {
    ...
    function pParts(end) {
      ...
      while (tok && tok !== "\n") {
        ...
        var unicodeIcon = Object.keys(unicodeIcons$2).find(function (name) {
          return unicodeIcons$2[name] === tok;
        });
        if (unicodeIcon) {
          next();
          var icon = unicodeIcon.slice(1, unicodeIcon.length);
            ...
            case "@":
              {
                ...
                children.push(Object.prototype.hasOwnProperty.call(Icon.icons, name) ? new Icon(name, modifiers) : new Label("@" + name + (modifiers.length ? "-" : "") + modifiers.join("-")));
                label = null;
                break;
              }
            case "\n":
    ...
    function pReporter() {
      ...
      if (block.info && block.info.shape === "ring") {
        ...
        if (first && first.isInput && first.shape === "number" && first.value === "") {
          block.children[0] = new Input(first.isCommand ? "stack" : first.isBoolean ? "boolean" : first.isRound ? "reporter" : "stack");
    ...
    scripts.forEach(function (script) {
      ...
      eachBlock(script, function (block) {
        ...
        if (block.info.shape === "define-hat") {
          ...
          var customBlock = block.children[0];
          var _names = [];
          var _parts = [];
          var _iterator5 = _createForOfIteratorHelper(customBlock.children),
            _step5;
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              ...
              if (_child2.isLabel) {
                ...
                if (_child2.value != "+") {
                  if (_child2.value === "$nl") {
                    ...
                    _parts.push(_child2.value);
                  }
                }
              } else if (_child2.isBlock) {
                if (!_child2.isUpvar) {
                  return;
                }
                var argument = "string";
                var argVar = _child2.children[0];

                // detect argument type from argVar name
                if (argVar.children.length > 1) {
                  var containsEq = argVar.children.find(function (child) {
                    return child.value == "=";
                  });
                  ...
                  if (containsEq) {
                    for (typePosition = argVar.children.length - 1; typePosition > 0; typePosition--) {
                      var argChild = argVar.children[typePosition];
                ...
                var _name2 = blockName(argVar);
                _names.push(_name2);
                customArgs.add(_name2);
              } else if (_child2.isIcon) {
                _parts.push("@" + _child2.name);
              }
            }
          } catch (err) {
            _iterator5.e(err);
          ...
          var _spec = _parts.join(" ");
          var _hash = hashSpec(_spec);
          ...
          if (!customBlocksByHash[_hash]) {
            customBlocksByHash[_hash] = _info;
          }
    ...
    scripts.forEach(function (script) {
      eachBlock(script, function (block) {
        if (block.info && block.info.categoryIsDefault && block.info.category === "obsolete") {
          ...
          var _info2 = customBlocksByHash[block.info.hash];
          if (_info2) {
            block.info.selector = "call";
            block.info.call = _info2.spec;
            block.info.names = _info2.names;
            block.info.category = _info2.category;
            // block.info.shape = info.shape
            block.info.isCustom = true;
          }
        }
        var name, info;
        if (block.isReporter && !block.info.isCustom && block.info.category === "variables" && block.info.categoryIsDefault) {
        ...
        // ring
        if (block.info && block.info.categoryIsDefault && block.info.category === "obsolete" && block.info.shape === "ring") {
        ...
        if (block.isBlock) {
          ...
          var _iterator6 = _createForOfIteratorHelper(block.children),
            _step6;
          try {
            for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
              var child = _step6.value;
  ...
  var SVG$2 = /*#__PURE__*/function () {
    ...
    _createClass(SVG, null, [{
      ...
      value: function init(window) {
        ...
        xml$2 = new DOMParser().parseFromString("<xml></xml>", "application/xml");
        SVG.XMLSerializer = window.XMLSerializer;
      }
    }, {
      key: "makeCanvas",
      value: function makeCanvas() {
        return document$2.createElement("canvas");
      }
    }, {
      key: "cdata",
      value: function cdata(content) {
        return xml$2.createCDATASection(content);
      }
    }, {
      key: "el",
      value: function el(name, props) {
        var el = document$2.createElementNS("http://www.w3.org/2000/svg", name);
      ...
      value: function move(dx, dy, el) {
        var currentValue = el.getAttributeNS(null, "transform");
        if (!currentValue) {
          SVG.setProps(el, {
      ...
      value: function translatePath(dx, dy, path) {
        ...
        for (var i = 0; i < parts.length; i++) {
          ...
          if (part === "A") {
            ...
            // operation.
            assert$1(isX, "translatePath: invalid argument");
          } else {
            part = +part;
            part += isX ? dx : dy;
            isX = !isX;
      ...
      key: "getRoundedTop",
      value: function getRoundedTop(w, h) {
        return "M 0 10\n      C 0 5 5 0 10 0\n      L " + (w - 10) + " 0\n      C " + (w - 5) + " 0 " + w + " 5 " + w + " 10";
      }
    }, {
      key: "getRoundedBottom",
      value: function getRoundedBottom(w, h) {
      ...
      key: "getPointedTop",
      value: function getPointedTop(w, h) {
        var r = 8;
        return "M " + r + " " + h + " L 0 " + h / 2 + " " + r + " 0 L " + (w - r) + " 0";
      }
    }, {
      key: "getPointedBottom",
      value: function getPointedBottom(w, h, showRight) {
        var r = 8;
        var path = "";
        if (showRight) {
          path += "L " + w + " " + h / 2 + " ";
  ...
  var Filter$1 = /*#__PURE__*/function () {
    function Filter(id, props) {
      this.el = SVG$2.el("filter", _objectSpread2(_objectSpread2({}, props), {}, {
        id: id,
        x0: "-50%",
        y0: "-50%",
        width: "200%",
    ...
    _createClass(Filter, [{
      ...
      value: function fe(name, props, children) {
        ...
        this.el.appendChild(SVG$2.withChildren(SVG$2.el("fe" + name, _objectSpread2(_objectSpread2({}, props), {}, {
          result: id
        })), children || []));
        return id;
      }
    ...
    _createClass(Style, null, [{
      ...
      value: function makeIcons() {
        return [SVG$2.el("path", {
          ...
          id: "verticalEllipsis"
        }), SVG$2.setProps(SVG$2.group([SVG$2.el("path", {
          d: "M 16 20 l 4 -4 l 0 -6 l 6 0 l -8 -10 l -8 10 l 6 0 l 0 6 l -16 0 l 0 4",
          fill: "#000",
          opacity: "0.3"
        }), SVG$2.move(-1, -1, SVG$2.el("path", {
          d: "M 16 20 l 4 -4 l 0 -6 l 6 0 l -8 -10 l -8 10 l 6 0 l 0 6 l -16 0 l 0 4",
          opacity: "0.9"
        }))]), {
          id: "loopArrow"
        }), SVG$2.setProps(SVG$2.group([SVG$2.el("rect", {
          x: "0",
          y: "0",
          width: "12",
          height: "14",
      ...
      value: function makeStyle() {
        var style = SVG$2.el("style");
        style.appendChild(SVG$2.cdata(Style.cssContent));
        return style;
      }
    }, {
      key: "bevelFilter",
      value: function bevelFilter(id, inset) {
        var f = new Filter$1(id);
      ...
      value: function darkRect(w, h, category, el) {
        return SVG$2.setProps(SVG$2.group([SVG$2.setProps(el, {
  ...
  var defaultFontFamily$1 = Style$2.defaultFontFamily,
    makeStyle$5 = Style$2.makeStyle,
    makeIcons$1 = Style$2.makeIcons,
    darkRect$1 = Style$2.darkRect,
    bevelFilter$1 = Style$2.bevelFilter,
    darkFilter$1 = Style$2.darkFilter;
  var unicodeIcons$1 = {
    cloud: "☁",
    cloudOutline: "☁"
  };
  var LabelView$2 = /*#__PURE__*/function () {
    function LabelView(label) {
      if (label.isIcon && unicodeIcons$1[label.name]) {
        _extends(this, {
          value: unicodeIcons$1[label.name]
        });
      } else {
        _extends(this, label);
      }
      ...
      value: function measure() {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            y += 10;
            group.push(SVG$2.text(0, y, line, {
              class: "sb-label " + cls
            }));
          }
        } catch (err) {
        ...
        if (Object.hasOwnProperty.call(cache, value)) {
          ...
          var font = /comment-label/.test(this.cls) ? "bold 12px Helvetica, Arial, DejaVu Sans, sans-serif" : /literal/.test(this.cls) ? "normal 9px " + defaultFontFamily$1 : "bold 10px " + defaultFontFamily$1;
  ...
  var IconView$2 = /*#__PURE__*/function () {
    ...
    _createClass(IconView, [{
      ...
      value: function draw() {
        ...
        if (Array.isArray(this.fillAttribute)) {
          var _iterator3 = _createForOfIteratorHelper(this.fillAttribute),
            _step3;
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              var fillAttribute = _step3.value;
              props[fillAttribute] = SVG$2.rgbToHex(this.r, this.g, this.b);
            }
          } catch (err) {
            _iterator3.e(err);
          } finally {
          ...
          props[this.fillAttribute] = SVG$2.rgbToHex(this.r, this.g, this.b);
        }
        var symbol = SVG$2.setProps(SVG$2.symbol("#" + this.name), props);
  ...
  var InputView$2 = /*#__PURE__*/function () {
    ...
    _createClass(InputView, [{
      ...
      value: function draw(parent) {
        ...
        this.width = w;
        var h = this.hasLabel ? this.label.height : 13;
        ...
        if (this.isColor) {
          ...
          el = darkRect$1(w, h, parent.info.category, el);
        ...
        var result = SVG$2.group([SVG$2.setProps(el, {
          class: "sb-input sb-input-" + this.shape
        })]);
        if (this.hasLabel) {
          var x = this.isRound ? 5 : 4;
          result.appendChild(SVG$2.move(x, 0, label));
        }
        if (this.hasArrow) {
          var y = this.shape === "dropdown" ? 5 : 4;
          result.appendChild(SVG$2.move(w - 10, y, SVG$2.polygon({
      ...
      get: function get() {
        return {
          string: SVG$2.rect,
          number: SVG$2.roundedRect,
          "number-dropdown": SVG$2.roundedRect,
          color: SVG$2.rect,
          dropdown: SVG$2.rect,
          boolean: SVG$2.pointedRect,
          stack: SVG$2.stackRect,
          reporter: SVG$2.roundedRect,
          ring: SVG$2.roundedRect
        };
      }
    }]);
    return InputView;
  }();
  var BlockView$2 = /*#__PURE__*/function () {
    ...
    _createClass(BlockView, [{
      ...
      value: function drawSelf(w, h, lines) {
        ...
        if (lines.length > 1) {
          ...
          if (this.info.shape === "stack") {
            p.push(SVG$2.getTop(w));
          } else if (this.info.shape === "boolean") {
            p.push(SVG$2.getPointedTop(w, h));
          } else if (this.info.shape === "reporter") {
            p.push(SVG$2.getRoundedTop(w, h));
          } else {
            p.push(SVG$2.getTop(w));
          }
          var isLast = false;
          var showBooleanRight = true;
          for (var i = 1; i < lines.length; i += 1) {
            isLast = i + 2 === lines.length;
            if (lines[i] instanceof ScriptView$2) {
              p.push(SVG$2.getRightAndBottom(w - (this.info.shape === "boolean") * 8, y, true, 15));
              y += lines[i].height - 3;
              p.push(SVG$2.getArm(w - (this.info.shape === "boolean") * 8, y));
              !(isLast && this.isFinal);
              y += lines[i + 1].height + 3;
          ...
          if (this.info.shape === "stack") {
            p.push(SVG$2.getRightAndBottom(w, y, !this.isFinal, 0));
          } else if (this.info.shape === "boolean") {
            p.push(SVG$2.getPointedBottom(w, y, showBooleanRight));
          } else if (this.info.shape === "reporter") {
            p.push(SVG$2.getRoundedBottom(w, y));
          } else {
            p.push(SVG$2.getRightAndBottom(w, y, !this.isFinal, 0));
          }
          return SVG$2.path({
        ...
        if (/outline-\w+/.test(this.info.shape)) {
          if (this.info.shape === "outline-stack") {
            return SVG$2.setProps(SVG$2.stackRect(w, h), {
              class: "sb-outline"
            });
          } else if (this.info.shape === "outline-reporter") {
            return SVG$2.setProps(SVG$2.roundedRect(w, h), {
              class: "sb-outline"
            });
          } else if (this.info.shape === "outline-boolean") {
            return SVG$2.setProps(SVG$2.pointedRect(w, h), {
              class: "sb-outline"
            });
          }
        }
        ...
        if (this.isRing) {
          ...
          if (child && (child.isStack || child.isBlock || child.isScript || child.isRound || child.isBoolean)) {
            ...
            return SVG$2.ringRect(w, h, child.y, child.width, child.height, shape, {
              class: "sb-" + this.info.category + " sb-bevel"
            });
          }
        }
      ...
      value: function draw() {
        ...
        var scriptWidth = 0;
        var line = new Line(y);
        var pushLine = function pushLine(type) {
        ...
        innerWidth = Math.max(innerWidth + px * 2, this.isHat ? 110 : this.hasScript ? 83 : this.isCommand || this.isOutline || this.isRing ? 39 : 20);
        this.height = y;
        ...
        for (var _i2 = 0, _lines = lines; _i2 < _lines.length; _i2++) {
          ...
          if (_line.isScript) {
            objects.push(SVG$2.move(15, _line.y, _line.el));
            continue;
          }
          var h = _line.height;
          var _iterator5 = _createForOfIteratorHelper(_line.children),
            _step5;
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              var _child = _step5.value;
              if (_child.isLoop) {
                objects.push(SVG$2.move(innerWidth - _child.width - 3 - (this.info.shape === "boolean") * 6, this.height - _child.height - 3, _child.el));
                continue;
              }
              ...
              objects.push(SVG$2.move(px + _child.x, _line.y + _y | 0, _child.el));
              if (_child.diff === "+") {
                var ellipse = SVG$2.insEllipse(_child.width, _child.height);
                objects.push(SVG$2.move(px + _child.x, _line.y + _y | 0, ellipse));
              }
            }
          } catch (err) {
            _iterator5.e(err);
      ...
      get: function get() {
        return {
          stack: SVG$2.stackRect,
          "c-block": SVG$2.stackRect,
          "if-block": SVG$2.stackRect,
          celse: SVG$2.stackRect,
          cend: SVG$2.stackRect,
          cap: SVG$2.capRect,
          reporter: SVG$2.roundedRect,
          boolean: SVG$2.pointedRect,
          hat: SVG$2.hatRect,
          cat: SVG$2.hatRect,
          "define-hat": SVG$2.procHatRect,
          "snap-define": SVG$2.hatRect,
          ring: SVG$2.roundedRect
        };
      }
    }, {
  ...
  var CommentView$2 = /*#__PURE__*/function () {
    ...
    _createClass(CommentView, [{
      ...
      value: function draw() {
        ...
        return SVG$2.group([SVG$2.commentLine(this.hasBlock ? CommentView.lineLength : 0, 6), SVG$2.commentRect(this.width, this.height, {
          class: "sb-comment"
        }), SVG$2.move(8, 4, labelEl)]);
      }
    }], [{
      key: "lineLength",
      get: function get() {
  ...
  var GlowView$2 = /*#__PURE__*/function () {
    ...
    _createClass(GlowView, [{
      ...
      value: function drawSelf() {
        ...
        if (c.isScript) {
          if (!c.isEmpty && c.blocks[0].isHat) {
            el = SVG$2.hatRect(w, h);
          } else if (c.isFinal) {
            el = SVG$2.capRect(w, h);
          } else {
            el = SVG$2.stackRect(w, h);
          }
        } else {
          el = c.drawSelf(w, h, []);
        }
        return SVG$2.setProps(el, {
      ...
      value: function draw() {
        ...
        // encircle
        return SVG$2.group([el, this.drawSelf()]);
      }
    }]);
    return GlowView;
  }();
  var ScriptView$2 = /*#__PURE__*/function () {
    ...
    _createClass(ScriptView, [{
      ...
      value: function draw(inside) {
        ...
        var y = 0;
        this.width = 0;
        var _iterator7 = _createForOfIteratorHelper(this.blocks),
          _step7;
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            ...
            children.push(SVG$2.move(x, y, child));
            this.width = Math.max(this.width, block.width);
            var diff = block.diff;
            if (diff === "-") {
              var dw = block.width;
              var dh = block.firstLine.height || block.height;
              children.push(SVG$2.move(x, y + dh / 2 + 1, SVG$2.strikethroughLine(dw)));
              this.width = Math.max(this.width, block.width);
            }
            y += block.height;
            ...
            if (comment) {
              ...
              var el = comment.draw();
              children.push(SVG$2.move(cx, cy - comment.height / 2, el));
        ...
        return SVG$2.group(children);
      }
    }]);
    return ScriptView;
  }();
  var DocumentView$2 = /*#__PURE__*/function () {
    ...
    _createClass(DocumentView, [{
      ...
      value: function render(cb) {
        ...
        var height = 0;
        var elements = [];
        var _iterator8 = _createForOfIteratorHelper(this.scripts),
          _step8;
        try {
          for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
            ...
            script.y = height;
            elements.push(SVG$2.move(0, height, script.draw()));
        ...
        // return SVG
        var svg = SVG$2.newSVG(width, height, this.scale);
        svg.appendChild(this.defs = SVG$2.withChildren(SVG$2.el("defs"), [bevelFilter$1("bevelFilter", false), bevelFilter$1("inputBevelFilter", true), darkFilter$1("inputDarkFilter")].concat(_toConsumableArray(makeIcons$1()))));
        svg.appendChild(SVG$2.group(elements));
        this.el = svg;
        return svg;
      }
      ...
      value: function exportSVGString() {
        ...
        var style = makeStyle$5();
        this.defs.appendChild(style);
        var xml = new SVG$2.XMLSerializer().serializeToString(this.el);
  ...
  var viewFor$2 = function viewFor(node) {
    if (node instanceof Icon && unicodeIcons$1[node.name]) {
      return LabelView$2;
    }
  ...
  var newView$2 = function newView(node, options) {
    return new (viewFor$2(node))(node, options);
  };

  function init$3(window) {
    SVG$2.init(window);
    LabelView$2.measuring = SVG$2.makeCanvas().getContext("2d");
  }
  var makeStyle$4 = Style$2.makeStyle;
  ...
  var SVG$1 = /*#__PURE__*/function () {
    ...
    _createClass(SVG, null, [{
      ...
      key: "getRoundedTop",
      value: function getRoundedTop(w, h, r) {
        if (!r && r !== 0) {
          r = r / 2;
        }
      ...
      key: "getRoundedBottom",
      value: function getRoundedBottom(w, h, r) {
        if (!r && r !== 0) {
          r = h / 2;
        }
  ...
  var cssContent$1 = "\n.sb3-label {\n  font: 500 12pt Helvetica Neue, Helvetica, sans-serif;\n  word-spacing: +1pt;\n}\n\n.sb3-literal-number,\n.sb3-literal-string,\n.sb3-literal-number-dropdown,\n.sb3-literal-dropdown {\n  word-spacing: 0;\n}\n\n.sb3-diff {\n  fill: none;\n  stroke: #000;\n}\n.sb3-diff-ins {\n  stroke-width: 2px;\n}\n.sb3-diff-del {\n  stroke-width: 3px;\n}\n\n\n .sb3-motion {\n  fill: #4c97ff;\n  stroke: #3373cc;\n}\n .sb3-motion-alt {\n  fill: #4280d7;\n}\n .sb3-motion-dark {\n  fill: #3373cc;\n}\n\n\n .sb3-looks {\n  fill: #9966ff;\n  stroke: #774dcb;\n}\n .sb3-looks-alt {\n  fill: #855cd6;\n}\n .sb3-looks-dark {\n  fill: #774dcb;\n}\n\n\n .sb3-sound {\n  fill: #cf63cf;\n  stroke: #bd42bd;\n}\n .sb3-sound-alt {\n  fill: #c94fc9;\n}\n .sb3-sound-dark {\n  fill: #bd42bd;\n}\n\n\n .sb3-control {\n  fill: #ffab19;\n  stroke: #cf8b17;\n}\n .sb3-control-alt {\n  fill: #ec9c13;\n}\n .sb3-control-dark {\n  fill: #cf8b17;\n}\n\n\n .sb3-events {\n  fill: #ffbf00;\n  stroke: #cc9900;\n}\n .sb3-events-alt {\n  fill: #e6ac00;\n}\n .sb3-events-dark {\n  fill: #cc9900;\n}\n\n\n .sb3-sensing {\n  fill: #5cb1d6;\n  stroke: #2e8eb8;\n}\n .sb3-sensing-alt {\n  fill: #47a8d1;\n}\n .sb3-sensing-dark {\n  fill: #2e8eb8;\n}\n\n\n .sb3-operators {\n  fill: #59c059;\n  stroke: #389438;\n}\n .sb3-operators-alt {\n  fill: #46b946;\n}\n .sb3-operators-dark {\n  fill: #389438;\n}\n\n\n .sb3-variables {\n  fill: #ff8c1a;\n  stroke: #db6e00;\n}\n .sb3-variables-alt {\n  fill: #ff8000;\n}\n .sb3-variables-dark {\n  fill: #db6e00;\n}\n\n\n .sb3-list {\n  fill: #ff661a;\n  stroke: #e64d00;\n}\n .sb3-list-alt {\n  fill: #ff5500;\n}\n .sb3-list-dark {\n  fill: #e64d00;\n}\n\n\n .sb3-custom {\n  fill: #ff6680;\n  stroke: #ff3355;\n}\n .sb3-custom-alt {\n  fill: #ff4d6a;\n}\n .sb3-custom-dark {\n  fill: #ff3355;\n}\n\n\n .sb3-extension {\n  fill: #0fbd8c;\n  stroke: #0b8e69;\n}\n .sb3-extension-alt {\n  fill: #0da57a;\n}\n .sb3-extension-dark {\n  fill: #0b8e69;\n}\n\n\n .sb3-obsolete {\n  fill: #ed4242;\n  stroke: #ca2b2b;\n}\n .sb3-obsolete-alt {\n  fill: #db3333;\n}\n .sb3-obsolete-dark {\n  fill: #ca2b2b;\n}\n\n\n .sb3-grey {\n  fill: #bfbfbf;\n  stroke: #909090;\n}\n .sb3-grey-alt {\n  fill: #b2b2b2;\n}\n .sb3-grey-dark {\n  fill: #909090;\n}\n\n\n .sb3-other {\n  fill: #bfbfbf;\n  stroke: #909090;\n}\n .sb3-other-alt {\n  fill: #b2b2b2;\n}\n .sb3-other-dark {\n  fill: #909090;\n}\n\n\nsvg .sb3-label {\n  fill: #fff;\n}\n\nsvg .sb3-input-color {\n  stroke: #fff;\n}\n\nsvg .sb3-input-number,\nsvg .sb3-input-string {\n  fill: #fff;\n}\nsvg .sb3-literal-number,\nsvg .sb3-literal-string {\n  fill: #575e75;\n}\n\nsvg .sb3-custom-arg {\n  fill: #ff6680;\n  stroke: #ff3355;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-motion {\n  fill: #80b5ff;\n  stroke: #3373cc;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-motion-alt {\n  fill: #b3d2ff;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-motion-dark {\n  fill: #3373cc;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-looks {\n  fill: #ccb3ff;\n  stroke: #774dcb;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-looks-alt {\n  fill: #ddccff;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-looks-dark {\n  fill: #774dcb;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-sound {\n  fill: #e19de1;\n  stroke: #bd42bd;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-sound-alt {\n  fill: #ffb3ff;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-sound-dark {\n  fill: #bd42bd;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-control {\n  fill: #ffbe4c;\n  stroke: #cf8b17;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-control-alt {\n  fill: #ffda99;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-control-dark {\n  fill: #cf8b17;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-events {\n  fill: #ffd966;\n  stroke: #cc9900;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-events-alt {\n  fill: #ffecb3;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-events-dark {\n  fill: #cc9900;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-sensing {\n  fill: #85c4e0;\n  stroke: #2e8eb8;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-sensing-alt {\n  fill: #aed8ea;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-sensing-dark {\n  fill: #2e8eb8;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-operators {\n  fill: #7ece7e;\n  stroke: #389438;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-operators-alt {\n  fill: #b5e3b5;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-operators-dark {\n  fill: #389438;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-variables {\n  fill: #ffa54c;\n  stroke: #db6e00;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-variables-alt {\n  fill: #ffcc99;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-variables-dark {\n  fill: #db6e00;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-list {\n  fill: #ff9966;\n  stroke: #e64d00;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-list-alt {\n  fill: #ffcab0;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-list-dark {\n  fill: #e64d00;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-custom {\n  fill: #ff99aa;\n  stroke: #e64d00;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-custom-alt {\n  fill: #ffccd5;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-custom-dark {\n  fill: #e64d00;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-extension {\n  fill: #13ecaf;\n  stroke: #0b8e69;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-extension-alt {\n  fill: #75f0cd;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-extension-dark {\n  fill: #0b8e69;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-obsolete {\n  fill: #fc6666;\n  stroke: #d32121;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-obsolete-alt {\n  fill: #fcb0b0;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-obsolete-dark {\n  fill: #d32121;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-grey {\n  fill: #bfbfbf;\n  stroke: #959595;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-grey-alt {\n  fill: #b2b2b2;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-grey-dark {\n  fill: #959595;\n}\n\n\n.scratchblocks-style-scratch3-high-contrast .sb3-other {\n  fill: #bfbfbf;\n  stroke: #959595;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-other-alt {\n  fill: #b2b2b2;\n}\n.scratchblocks-style-scratch3-high-contrast .sb3-other-dark {\n  fill: #959595;\n}\n\n\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-label {\n  fill: #000;\n}\n\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-input-color {\n  stroke: #fff;\n}\n\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-input-number,\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-input-string {\n  fill: #fff;\n}\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-literal-number,\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-literal-string {\n  fill: #000;\n}\n\nsvg.scratchblocks-style-scratch3-high-contrast .sb3-custom-arg {\n  fill: #ff99aa;\n  stroke: #e64d00;\n}\n\n/* Note: comment colors are different from Scratch. */\n\n.sb3-comment {\n  fill: #ffffa5;\n  stroke: #d0d1d2;\n  stroke-width: 1;\n}\n.sb3-comment-line {\n  fill: #ffff80;\n}\n/* specificity */\n.sb3-comment-label, .sb3-label.sb3-comment-label {\n  font: 400 12pt Helvetica Neue, Helvetica, sans-serif;\n  fill: #000;\n  word-spacing: 0;\n}";

  // Need to define here, as we cannot reference Style#makeNewIcons
  // during JS loading phase.
  var highContrastIcons$1 = new Set(["dropdownArrow", "turnRight", "turnLeft", "loopArrow", "musicBlock", "penBlock", "videoBlock", "ttsBlock", "translationBlock", "cloud", "turtle", "turtleOutline", "flash", "arrowUp", "arrowUpOutline", "arrowUpThin", "arrowDown", "arrowDownOutline", "arrowDownThin", "arrowLeft", "arrowLeftOutline", "arrowLeftThin", "arrowRight", "arrowRightOutline", "arrowRightThin", "arrowUpDownThin", "arrowLeftRightThin", "pointRight"]);
  var Style$1 = /*#__PURE__*/function () {
    ...
    _createClass(Style, null, [{
      ...
      value: function makeCommonIcons() {
        return [SVG$1.setProps(SVG$1.group([SVG$1.el("path", {
          ...
          id: "sb3-greenFlag"
        }), SVG$1.setProps(SVG$1.el("polygon", {
      ...
      value: function makeOriginalIcons() {
        return [].concat(_toConsumableArray(Style.makeCommonIcons()), [SVG$1.setProps(SVG$1.group([SVG$1.el("path", {
          ...
          fill: "none",
          "stroke-linejoin": "round"
        }), SVG$1.setProps(SVG$1.group([SVG$1.el("circle", {
          opacity: 0.25,
          cx: 32,
          cy: 16,
          r: 4.5
      ...
      value: function iconName(name, iconStyle) {
        if (iconStyle === "high-contrast" && highContrastIcons$1.has(name)) {
  ...
  _defineProperty(Style$1, "highContrastIcons", highContrastIcons$1);

  var defaultFont = Style$1.defaultFont,
    commentFont = Style$1.commentFont,
    makeStyle$3 = Style$1.makeStyle,
    makeOriginalIcons = Style$1.makeOriginalIcons,
    makeHighContrastIcons = Style$1.makeHighContrastIcons,
    iconName = Style$1.iconName,
    highContrastIcons = Style$1.highContrastIcons;
  var unicodeIcons = {
    cloud: "☁",
    cloudOutline: "☁"
  };
      ...
      value: function measure() {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            group.push(SVG$1.text(0, y - this.lineHeight, line, {
              class: "sb3-label " + cls
            }));
          }
        } catch (err) {
      ...
      value: function draw(iconStyle) {
        ...
        if (Array.isArray(this.fillAttribute)) {
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              var fillAttribute = _step3.value;
              props[fillAttribute] = SVG$1.rgbToHex(this.r, this.g, this.b);
            }
          } catch (err) {
            _iterator3.e(err);
          } finally {
          ...
          props[this.fillAttribute] = SVG$1.rgbToHex(this.r, this.g, this.b);
        }
        var symbol = SVG$1.setProps(SVG$1.symbol("#sb3-" + iconName(this.name, iconStyle)), props);
        // console.log("symbol", symbol)
        return symbol;
      }
    }], [{
  ...
  var InputView$1 = /*#__PURE__*/function () {
    ...
    _createClass(InputView, [{
      ...
      value: function draw(iconStyle, parent) {
        ...
        this.width = w;
        var h = this.hasLabel ? this.label.height + 19 : 32;
        if (this.isRound || this.isColor) {
          h += 1;
        }
        this.height = h;
        ...
        var result = SVG$1.group([el]);
        if (this.hasLabel) {
          result.appendChild(label);
        }
        if (this.hasArrow) {
          result.appendChild(SVG$1.move(w - 24, 13, SVG$1.symbol(iconStyle === "high-contrast" ? "#sb3-dropdownArrow-high-contrast" : "#sb3-dropdownArrow", {})));
        }
        return result;
      }
    }], [{
      ...
      get: function get() {
        return {
          string: SVG$1.pillRect,
          number: SVG$1.pillRect,
          "number-dropdown": SVG$1.pillRect,
          color: SVG$1.pillRect,
          dropdown: SVG$1.roundRect,
          boolean: SVG$1.pointedRect,
          stack: SVG$1.stackRect,
          reporter: SVG$1.pillRect
        };
      }
    }]);
    return InputView;
    ...
    _createClass(BlockView, [{
      ...
      value: function drawSelf(iconStyle, w, h, lines) {
        ...
        if (lines.length > 1) {
          ...
          // console.log("shape", this.info.shape)
          if (this.info.shape === "stack") {
            p.push(SVG$1.getTop(w));
          } else if (this.info.shape === "reporter") {
            p.push(SVG$1.getRoundedTop(w, h, Math.max(lines[0].height, lines[lines.length - 1].height) / 2));
          } else if (this.info.shape === "boolean") {
            p.push(SVG$1.getPointedTop(w, h));
          } else {
            p.push(SVG$1.getTop(w));
          }
          var isLast = false;
          ...
          for (var i = 1; i < lines.length; i += 1) {
            isLast = i + 2 === lines.length;
            if (lines[i] instanceof ScriptView$1) {
              p.push(SVG$1.getRightAndBottom(w - (this.info.shape === "boolean") * 20, y, true, 15));
              y += lines[i].height - 3;
              p.push(SVG$1.getArm(w - (this.info.shape === "boolean") * 20, y));
              !(isLast && this.isFinal);
              y += lines[i + 1].height + 3;
              showBooleanRight = false;
              i++;
          ...
          if (this.info.shape === "stack") {
            p.push(SVG$1.getRightAndBottom(w, y, !this.isFinal, 0));
          } else if (this.info.shape === "reporter") {
            // console.log("sb3 lines", lines)
            p.push(SVG$1.getRoundedBottom(w, y, Math.max(lines[0].height, lines[lines.length - 1].height) / 2));
          } else if (this.info.shape === "boolean") {
            p.push(SVG$1.getPointedBottom(w, h, showBooleanRight));
          } else {
            p.push(SVG$1.getRightAndBottom(w, y, !this.isFinal, 0));
          }
          return SVG$1.path({
        ...
        if (/outline-\w+/.test(this.info.shape)) {
          if (this.info.shape === "outline-stack") {
            ...
            return SVG$1.setProps(SVG$1.pillRect(w, h), {
              class: "sb3-" + this.info.category + " sb3-" + this.info.category + "-alt"
            });
          } else if (this.info.shape === "outline-boolean") {
            return SVG$1.setProps(SVG$1.pointedRect(w, h), {
              class: "sb3-" + this.info.category + " sb3-" + this.info.category + "-alt"
            });
          }
        }
      ...
      value: function draw(iconStyle) {
        ...
        for (var _i2 = 0; _i2 < lines.length; _i2++) {
          var _line = lines[_i2];
          if (_line.isScript) {
            objects.push(SVG$1.move(16, _line.y, _line.el));
            continue;
          }
          var h = _line.height;
          for (var j = 0; j < _line.children.length; j++) {
            ...
            if (_child.isLoop) {
              objects.push(SVG$1.move(innerWidth - 32, this.height - 28, _child.el));
              continue;
            }
            ...
            objects.push(SVG$1.move(x, _line.y + _y | 0, _child.el));
          }
        }
    ...
    _createClass(DocumentView, [{
      ...
      value: function render(cb) {
        ...
        for (var i = 0; i < this.scripts.length; i++) {
          ...
          script.y = height;
          elements.push(SVG$1.move(0, height, script.draw(this.iconStyle)));
          height += script.height;
        ...
        svg.appendChild(this.defs = SVG$1.withChildren(SVG$1.el("defs"), icons));
        svg.appendChild(SVG$1.setProps(SVG$1.group(elements), {
  ...
  var SVG = /*#__PURE__*/function () {
    ...
    _createClass(SVG, null, [{
      ...
      value: function getRightAndBottom(w, y, hasNotch, inset) {
        ...
        var arr = ["L", w, y - 5, "C", w, y - 2, w - 2, y, w - 5, y];
        if (hasNotch) {
          arr = arr.concat(["L", inset + 27, y, "L", inset + 24, y + 3, "L", inset + 16, y + 3, "L", inset + 13, y]);
        }
        if (inset > 0) {
          arr = arr.concat(["L", inset + 5, y]);
          arr = arr.concat(["C", inset + 2, y, inset, y + 2, inset, y + 5]);
        } else {
          arr = arr.concat(["L", inset + 5, y]);
          arr = arr.concat(["C", inset + 2, y, inset, y - 2, inset, y - 5]);
        }
      ...
      key: "getArm",
      value: function getArm(w, armTop, inset) {
        if (!inset && inset !== 0) {
          inset = 10;
        }
      ...
      value: function hatRect(w, h, props) {
        return SVG.path(_objectSpread2(_objectSpread2({}, props), {}, {
          path: ["M", 0, 12, SVG.arc(0, 12, 35, 0, 50, 50), "C", 70, 0, 70, 12, Math.min(70 * 1.7, w - 5), 12, "L", w - 5, 12, "C " + (w - 2) + " 12 " + w + " 13 " + w + " 17", SVG.getRightAndBottom(w, h, true), "Z"]
        }));
      }
    }, {
      key: "curve",
  ...
  var Filter = /*#__PURE__*/function () {
    function Filter(id, props) {
      this.el = SVG.el("filter", _objectSpread2(_objectSpread2({}, props), {}, {
        id: id,
        x0: "-50%",
        y0: "-50%",
        width: "200%",
    ...
    _createClass(Filter, [{
      ...
      value: function fe(name, props, children) {
        var shortName = name.toLowerCase().replace(/gaussian|osite/, "");
        var id = shortName + "-" + ++this.highestId;
        this.el.appendChild(SVG.withChildren(SVG.el("fe" + name, _objectSpread2(_objectSpread2({}, props), {}, {
          result: id
        })), children || []));
        return id;
      }
      ...
      key: "dropShadow",
      value: function dropShadow(dx, dy, blur, color, opacity) {
  ...
  var Style = /*#__PURE__*/function () {
    ...
    _createClass(Style, null, [{
      ...
      key: "dropShadowFilter",
      value: function dropShadowFilter(id) {
        var f = new Filter(id);
      ...
      value: function bevelFilter(id, inset) {
        var f = new Filter(id);
        var alpha = "SourceAlpha";
        var blur = f.blur(0.4, alpha);
        f.merge(["SourceGraphic", f.comp("in", f.flood("#fff", 0.7), f.subtract(alpha, f.offset(inset ? -0.3 : 0.3, inset ? -0.3 : 0.3, blur))), f.comp("in", f.flood("#000", inset ? 0.8 : 0.99), f.subtract(alpha, f.offset(inset ? 0.8 : -0.8, inset ? 0.8 : -0.8, blur)))]);
        return f.el;
      }
    }, {
      key: "darkFilter",
      ...
      key: "darkRect",
      value: function darkRect(w, h, category, el) {
        return SVG.setProps(SVG.group([SVG.setProps(el, {
  ...
  var defaultFontFamily = Style.defaultFontFamily,
    ...
    dropShadowFilter = Style.dropShadowFilter;
  ...
  var IconView = /*#__PURE__*/function () {
    ...
    _createClass(IconView, [{
      ...
      value: function draw() {
        ...
        var symbol = SVG.setProps(SVG.symbol("#snap-" + this.name), props);
        // console.log('symbol', symbol)
  ...
  var InputView = /*#__PURE__*/function () {
    ...
    _createClass(InputView, [{
      ...
      value: function draw(parent) {
        ...
        if (this.hasLabel) {
          label = this.label.draw();
          w = Math.max(this.shape === "string" ? 5 : 14, this.label.width + (this.shape === "string" || this.shape === "number-dropdown" ? 6 : 9));
        } else {
          w = this.isInset ? 30 : this.isColor ? 13 : null;
        }
        if (this.hasArrow) {
        ...
        var result = SVG.group([SVG.setProps(el, {
  ...
  var BlockView = /*#__PURE__*/function () {
    ...
    _createClass(BlockView, [{
      ...
      value: function draw() {
        ...
        innerWidth = Math.max(innerWidth + px * 2, this.isHat ? 110 : this.hasScript ? 39 : this.isCommand || this.isOutline || this.isRing ? 39 : 20);
        this.height = y;
        this.width = scriptWidth ? Math.max(innerWidth, 15 + scriptWidth) : innerWidth;
        if (isDefine) {
          var p = Math.min(26, 3.5 + 0.13 * innerWidth | 0) - 18;
        ...
        for (var _i2 = 0, _lines = lines; _i2 < _lines.length; _i2++) {
          var _line = _lines[_i2];
          if (_line.isScript) {
            objects.push(SVG.move(8, _line.y, _line.el));
            continue;
          }
          var h = _line.height;
          var _iterator5 = _createForOfIteratorHelper(_line.children),
          ...
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              var _child = _step5.value;
              if (_child.isLoop) {
                objects.push(SVG.move(innerWidth - _child.width - 3 - (this.info.shape === 'boolean') * 6, this.height - _child.height - 3, _child.el));
              ...
              objects.push(SVG.move(px + _child.x, _line.y + _y | 0, _child.el));
              if (_child.diff === "+") {
                var ellipse = SVG.insEllipse(_child.width, _child.height);
                objects.push(SVG.move(px + _child.x, _line.y + _y | 0, ellipse));
              }
            }
          } catch (err) {
            _iterator5.e(err);
  ...
  var DocumentView = /*#__PURE__*/function () {
    ...
    _createClass(DocumentView, [{
      ...
      value: function render(cb) {
        ...
        svg.appendChild(this.defs = SVG.withChildren(SVG.el("defs"), [bevelFilter("snapBevelFilter", false), bevelFilter("snapInputBevelFilter", true), darkFilter("inputDarkFilter"), dropShadowFilter('snapDropShadow')].concat(_toConsumableArray(makeIcons()))));
  ...
  function init (window) {
    ...
    function appendStyles() {
      ...
      document.head.appendChild(makeStyle$4());
      document.head.appendChild(makeStyle$2());
    }
    function newView$3(doc, options) {
      options = _objectSpread2({
        style: "snap"
      }, options);
    ...
    function render(doc, options) {
      ...
      var view = newView$3(doc, options);
      var svg = view.render();
